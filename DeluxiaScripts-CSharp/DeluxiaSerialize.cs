...
public static class DeluxiaSerialize{
    ...
    /// </summary>
    public static byte[] SerializeNormalString(string text){
        text = text.Zip();
        char[] text2 = text.ToCharArray(); 
        byte[] toSend = new byte[text.Length];
        for (int i = 0; i < toSend.Length; i++){
            toSend[i] = (byte)text2[i];
        }
        return toSend;
    }
    /// <summary>
    ...
    /// </summary>
    public static string SerializeToNormalString(byte[] data){
